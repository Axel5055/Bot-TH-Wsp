...
const filePath = "./commands/functions/excel/escudos.xlsx"; // Ruta del archivo Excel
const usageFilePath = "./commands/functions/usage.json"; // Ruta para almacenar el historial de uso
